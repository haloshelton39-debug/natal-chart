...
Этот файл — исторический генератор, которым когда-то создавался `index.html`.
Содержимое может устаревать и при запуске перезапишет актуальную версию страницы.
